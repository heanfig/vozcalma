...
export function buildQuickPrompt(answers: Record<string, string>): {
  ...
  const system = [
    ...
    "",
    "PAUSAS (MUY IMPORTANTE):",
    "- Inserta líneas que contengan SOLO '...' para indicar pausas de respiración.",
    "- Usa bloques de 2-3 líneas de '...' seguidas para pausas largas de respiración profunda.",
    "- El guion debe tener AL MENOS 6 pausas de respiración distribuidas naturalmente.",
...
export function buildDeepPrompt(answers: Record<string, string>): {
  ...
  const system = [
    ...
    "",
    "PAUSAS (MUY IMPORTANTE):",
    "- Inserta líneas que contengan SOLO '...' para indicar pausas.",
    "- Usa bloques de 2-4 líneas de '...' para pausas largas de respiración.",
    "- El guion debe tener AL MENOS 10 pausas de respiración distribuidas.",
    "- Entre cada sección mayor debe haber una pausa larga (2-3 líneas de '...').",
    "",
    "PERSONALIZACIÓN (CRÍTICO):",
